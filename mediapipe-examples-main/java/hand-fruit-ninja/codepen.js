...
function onResults(results) {
  if (results.multiHandLandmarks && results.multiHandedness) {
    global_x = results.multiHandLandmarks[0][8].x * 1280; // Index 8 is index fingertip
    global_y = results.multiHandLandmarks[0][8].y * 720; // Index 8 is index fingertip
...
new ControlPanel(controlsElement, {
  ...
  .add([
    new StaticText({ title: "Use your index fingertip to cut the green circles" }),
